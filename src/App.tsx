...
import { 
  faPlane, faMapMarkerAlt, faUtensils, faCar, 
  faWallet, faBookOpen, faSuitcase, faUserFriends,
  faCloudSun, faCloudRain, faSnowflake, faClock, faCamera,
  faBed, faUnlock, faLock, faEye, faEyeSlash, faPassport,
  faPlus, faTimes, faReceipt, faShoppingBag, faTicketAlt, faBackspace, faPaperPlane, faImage, faHeart, faBus
} from '@fortawesome/free-solid-svg-icons'; // Removed unused icons like faHotel, faShip, faTrain
import { format, differenceInDays, addDays, parseISO } from 'date-fns';
import { zhTW } from 'date-fns/locale';

// --- 1. Types & Interfaces ---
// FIX: Added 'car' to CategoryType
type CategoryType = 'flight' | 'stay' | 'activity' | 'food' | 'transport' | 'shopping' | 'other' | 'car';
...
interface Booking {
  id: string;
  // FIX: Added 'transport' to Booking type
      ...
      {showPinModal && (
        <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-6 backdrop-blur-sm">
          <div className="bg-white rounded-3xl p-8 w-full max-w-sm shadow-2xl text-center">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx